"""temping_21093 URL Configuration
...
admin.site.site_header = "temping"
admin.site.site_title = "temping Admin Portal"
admin.site.index_title = "temping Admin"

# swagger
api_info = openapi.Info(
    title="temping API",
    default_version="v1",
    description="API documentation for temping App",
)
